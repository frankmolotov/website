...
class RegisterForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['user_name'].error_messages = {'required': 'Bitte geben Sie Ihre E-mail ein.'}
        self.fields['email'].error_messages = {'required': 'Bitte geben Sie Ihre E-mail ein.'}
        self.fields['phone_number'].error_messages = {'required': 'Bitte geben Sie Ihre E-mail ein.'}
